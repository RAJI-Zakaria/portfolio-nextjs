...
const LinkedInIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    height={size || height}
    width={size || width}
    viewBox="0 0 72 72"
  ...
  >
    <g fill="none" fillRule="evenodd">
      ...
      <path
        ...
        className="fill-black dark:fill-[#a1a2ab]"
      />
    </g>
  </svg>
);
...
const LinkIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
...
const ArrowChevronRightIcon = ({ className = "", ...props }: IconSvgProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
    <path d="M7.293 4.707 14.586 12l-7.293 7.293 1.414 1.414L17.414 12 8.707 3.293 7.293 4.707z" />
  </svg>
);

const ArrowChevronLeftIcon = ({ className = "", ...props }: IconSvgProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
