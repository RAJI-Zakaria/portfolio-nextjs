export const projects = [
  {
    ...
    description: `<h3>Introduction</h3>
            <p>What a splendid application that i've managed to create thanks to JavaScript Mastery tutorial on youtube</p>
            <br />
            ...
            <ul className="list-disc bg-red-800">
                ...
                <li> - Server Actions to manipulate the forms data instead of using api endpoints</li>
            </ul><br />
            <h2>SaaS Features :</h2>
            <ul className="list-disc">
                ...
                <li> - Object Remove</li>
                <li> - Object Recolor</li>
                <li> - Background Remove</li>
            </ul><br />
            <h2>Deployment</h2>
            <p><a href="https://ai-image-tool.vercel.app/">https://ai-image-tool.vercel.app/</a></p><br />
            <h2>Code</h2>
